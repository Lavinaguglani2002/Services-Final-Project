...
// <Route path="/my-orders" element={<UserOrders userEmail={localStorage.getItem("EMAIL")} />} />
...
//        <Route path="getpendingorders" element={<Getorders/>}></Route>
//         </Route>

//         {/* User Dashboard - Protected Route */}
//         <Route path="/userdashboard" element={<PrivateRoute ><UserDashboard /></PrivateRoute>} />
        
//         {/* Protected Navbar Route (If Navbar should be protected) */}
//       </Routes>
//     </BrowserRouter>
//   );
// }
